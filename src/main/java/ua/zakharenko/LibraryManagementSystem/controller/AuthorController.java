...
public class AuthorController {
	...
	public String createAuthor(@ModelAttribute("author") @Valid Author author, BindingResult result, Model model) {
		if (result.hasErrors()) {
			return "/add-author";
		}
	...
	public String updateAuthor(@PathVariable("id") Long id,@ModelAttribute("author") @Valid Author author,
