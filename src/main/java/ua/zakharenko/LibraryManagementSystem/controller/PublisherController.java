...
public class PublisherController {
	...
	public String createPublisher(@ModelAttribute("publisher") @Valid Publisher publisher,
	...
	public String updatePublisher(@PathVariable("id") Long id, @ModelAttribute("publisher") @Valid Publisher publisher,
								  BindingResult result, Model model) {
		if (result.hasErrors()) {
			publisher.setId(id);
			return "update-publisher";
